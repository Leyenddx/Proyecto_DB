                ...
                <table class="table table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        //Esta tabla funciona correctamente
                            $consulta = "SELECT inventario.id_producto, parte.nombre AS nombre_parte, cliente.nombre AS nombre_cliente, locacion.nombre_locacion AS nombre_locacion, inventario.cantidad
                                        FROM inventario
                                        INNER JOIN parte ON inventario.id_parte = parte.id_parte
                                        INNER JOIN cliente ON inventario.id_cliente = cliente.id_cliente
                                        INNER JOIN locacion ON inventario.id_locacion = locacion.id_locacion";
